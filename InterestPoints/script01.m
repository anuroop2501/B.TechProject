...
clear all;clc
stippath='stip/data/running_txt/train';
path = 'stip/data/running';
datapath='data';
...
if 1 % read image sequences
  if 1
    % from avi videos 
    f1=wmvReadImageSave([path '/person01_running_d1_uncomp.avi'],[1,100]);
    f2=wmvReadImageSave([path '/person01_running_d2_uncomp.avi'],[1,100]);
...
if 1 % load and display features
  [pos1,val1,dscr1]=readstips_text([stippath '/person01_running_d1_uncomp.txt']);
  [pos2,val2,dscr2]=readstips_text([stippath '/person01_running_d2_uncomp.txt']);
